...
export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/iphone13.gltf')
  return (
      ...
      <group position={[0, 0, -0.01]} rotation={[-Math.PI / 2, 0, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          <group scale={100}>
            ...
            <mesh geometry={nodes.Apple_Logo_Logo_0.geometry} position={[0, 0, 0.000008]} material={materials.Logo} />
